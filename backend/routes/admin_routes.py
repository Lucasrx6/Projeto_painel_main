    ...
    try:
        paineis = [
            ...
            {'nome': 'painel9', 'titulo': 'Lab Pendentes',
             'descricao': 'Lab pendentes', 'ativo': True},
            {'nome': 'painel10', 'titulo': 'Painel PS',
             'descricao': 'Desempenho PS', 'ativo': True},
            {'nome': 'painel11', 'titulo': 'Painel Internação',
             'descricao': 'Pedidos de internação', 'ativo': True},
            {'nome': 'painel12', 'titulo': 'Painel Ocupação e Produção',
             'descricao': 'Informações gerenciais', 'ativo': True},
            {'nome': 'painel13', 'titulo': 'Mapa de Nutrição',
             'descricao': 'Informações de nutrição', 'ativo': True},
            {'nome': 'painel14', 'titulo': 'Chamados T.I',
             'descricao': 'Gerencia de chamados emergenciais', 'ativo': True},
            {'nome': 'painel15', 'titulo': 'Abrir Chamados',
             'descricao': 'Abrir chamados emergenciais', 'ativo': True},
            {'nome': 'painel16', 'titulo': 'Desempenho Recepcao',
             'descricao': 'Acompanhar a recepcao', 'ativo': True},
            {'nome': 'painel17', 'titulo': 'Tempo Atendimento PS',
             'descricao': 'Demonstrativo de tempo de espera no PS', 'ativo': True},
            {'nome': 'painel18', 'titulo': 'Desempenho Médico PS',
             'descricao': 'Demonstrativo de produção médico PS', 'ativo': True},
            {'nome': 'painel19', 'titulo': 'Pendencias Radiologia',
             'descricao': 'Pendencias da Radiologia', 'ativo': True},
            {'nome': 'painel20', 'titulo': 'Pendencias Radiologia NO PS',
             'descricao': 'Pendencias da Radiologia no PS', 'ativo': True},
            {'nome': 'painel21', 'titulo': 'Status contas ',
             'descricao': 'Acompanhar status das contas HAC', 'ativo': True},
            {'nome': 'painel22', 'titulo': 'Exames Pendentes PS ',
             'descricao': 'Exames pendentes do PS', 'ativo': True},
            {'nome': 'painel23', 'titulo': 'Atendimentos Ambulatório',
             'descricao': 'Informações do Ambulatório', 'ativo': True},
            {'nome': 'painel24', 'titulo': 'Estoque Dia',
